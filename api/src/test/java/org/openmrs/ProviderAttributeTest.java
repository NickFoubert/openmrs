...
public class ProviderAttributeTest {
    ...
    public void compareTo_shouldCompareAsEqualForSameAttributeTypeNames() throws Exception {
        ...
        ProviderAttribute providerAttribute1 = createProviderAttribute(providerAttributeType, new SimpleDateFormat("yyyy-MM-dd").parse("2011-04-25"));
        ProviderAttribute providerAttribute2 = createProviderAttribute(providerAttributeType, new SimpleDateFormat("yyyy-MM-dd").parse("2011-04-25"));
    ...
    public void compareTo_shouldCompareBasedOnSerializedValueWhenAttributeTypesAreSame() throws Exception {
        ...
        providerAttributeType.setDatatype("string");
        ProviderAttribute providerAttribute1 = createProviderAttribute(providerAttributeType, new SimpleDateFormat("yyyy-MM-dd").parse("2011-04-25"));
        ProviderAttribute providerAttribute2 = createProviderAttribute(providerAttributeType, new SimpleDateFormat("yyyy-MM-dd").parse("2012-04-25"));
        Assert.assertTrue(providerAttribute1.compareTo(providerAttribute2) < 0);
        Assert.assertTrue(providerAttribute2.compareTo(providerAttribute1) > 0);
    }
    ...
    private ProviderAttribute createProviderAttribute(AttributeType<Provider> providerAttributeType, Object value) throws Exception {
