...
public class HibernateVisitDAO implements VisitDAO {
	...
	public List<Visit> getVisits(Collection<VisitType> visitTypes, Collection<Patient> patients,
	        ...
	        Date minEndDatetime, Date maxEndDatetime, final Map<AttributeType, String> serializedAttributeValues,
		...
		if (serializedAttributeValues != null) {
			CollectionUtils.filter(visits, new AttributeMatcherPredicate<Visit>(serializedAttributeValues));
		}
