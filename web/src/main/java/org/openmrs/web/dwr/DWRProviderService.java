...
public class DWRProviderService {
	 ...
	 * @should return the list of providers including voided providers for the matching search name
	 */
	...
	/**
	 * Finds providers for the given name along with he total count of providers that matched.
	 * 
	 * @param name to search
	 * @param includeVoided true/false whether or not to included voided patients
	 * @param start starting index for the results to return
	 ...
	 *         for given length
	 */
	public Map<String, Object> findProviderCountAndProvider(String name, boolean includeVoided, Integer start, Integer length)
	        throws APIException {
		Map<String, Object> providerMap = new HashMap<String, Object>();
		Vector<Object> objectList = findProvider(name, includeVoided, start, length);
		try {
